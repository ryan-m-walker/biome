...
pub fn kind_by_name(node_name: &str) -> Option<CssSyntaxKind> {
    match node_name {
        ...
        "CssIfBooleanAnd" => lang::CssIfBooleanAnd::KIND_SET.iter().next(),
        "CssIfBooleanNot" => lang::CssIfBooleanNot::KIND_SET.iter().next(),
        "CssIfBooleanOr" => lang::CssIfBooleanOr::KIND_SET.iter().next(),
        "CssIfBooleanParenthesized" => lang::CssIfBooleanParenthesized::KIND_SET.iter().next(),
        "CssIfBranch" => lang::CssIfBranch::KIND_SET.iter().next(),
        "CssIfCondition" => lang::CssIfCondition::KIND_SET.iter().next(),
        ...
        "CssIfSupportsDeclaration" => lang::CssIfSupportsDeclaration::KIND_SET.iter().next(),
